...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('fronttabs_core_path', null, $modx->getOption('core_path') . 'components/fronttabs/') . 'model/';
            $modx->addPackage('fronttabs', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/fronttabs/model/schema/fronttabs.mysql.schema.xml';
